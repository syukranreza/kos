            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" class="form-control" name="no_kamar" value="{{ old('no_kamar') }}">
                    </div>
                    <div class="form-group mb-2">
                        <label for="">Deskripsi Kamar</label>
                        <textarea name="deskripsi_kamar" id="editor" rows="3" class="form-control">{{ old('deskripsi_kamar') }}</textarea>
                    </div>
                    <div class="form-group mb-2">
                        <label for="">Harga Kamar / Bulan</label>
                        <input type="number" class="form-control" name="harga_kamar" value="{{ old('harga_kamar') }}">
                    </div>
